    ...
    <div className="container-fluid px-4 py-5 mb-5" id="pet-categories">
      ...
      <div className="row g-4 py-5 row-cols-1 row-cols-md-3 justify-content-center">
        <div className="col d-flex flex-column align-items-center text-center">
          ...
          <a href="https://www.petmd.com" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Learn More</a>
        </div>
        <div className="col d-flex flex-column align-items-center text-center">
          ...
          <a href="https://www.cesarsway.com/dog-training/" target="_blank" rel="noopener noreferrer" className="btn btn-success">Learn More</a>
        </div>
        <div className="col d-flex flex-column align-items-center text-center">
          ...
          <a href="https://www.aspca.org/pet-care/cat-care" target="_blank" rel="noopener noreferrer" className="btn btn-warning">Learn More</a>
        </div>
        <div className="col d-flex flex-column align-items-center text-center">
          ...
          <a href="https://www.petfinder.com" target="_blank" rel="noopener noreferrer" className="btn btn-danger">Learn More</a>
        </div>
        <div className="col d-flex flex-column align-items-center text-center">
          ...
          <p>Browse  range of pet accessories and find everything you need for your pets.</p>
          <a href="https://www.chewy.com/b/accessories-404" target="_blank" rel="noopener noreferrer" className="btn btn-dark">Learn More</a>
        </div>
      </div>
    </div>
  );
